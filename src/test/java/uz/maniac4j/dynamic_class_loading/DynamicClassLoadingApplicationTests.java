...
//        InMemoryFileManager manager = new InMemoryFileManager(compiler.getStandardFileManager(null, null, null), new DynamicClassLoader(Thread.currentThread().getContextClassLoader()));
//
